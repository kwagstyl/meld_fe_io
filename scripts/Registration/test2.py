...
img2_reg = '/Users/niccolo/PycharmProjects/modality_overlay_vis/H101/sub-MELDH101P00073/anat/sub-MELDH101P00001_3T_preop_FLAIR_reg.nii.gz'
seg_reg = '/Users/niccolo/PycharmProjects/modality_overlay_vis/H101/sub-MELDH101P00073/anat/sub-MELDH101P00001_FLAIR_roi_reg.nii.gz'
...
modality_helper.display_image_seg(img1, img2, seg=seg, superimpose=True, save_name="img_pre_reg_2", colormap='jet')  # colormap='gray'



# after registration:
modality_helper = DisplayModalities()
modality_helper.display_image_seg(img1, img2_reg, seg=seg_reg, superimpose=True, save_name="img_post_reg_2", colormap='jet')  # colormap='gray'
